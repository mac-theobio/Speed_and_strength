...
%DIF ADD speedstrength.tex                       Tue Mar  9 15:30:35 2021
...
%DIF 8-9d8
%DIF < \title{Speed and strength of an epidemic intervention}
%DIF < \author{Jonathan Dushoff, Sang Woo Park}
%DIF -------
...
\title{\DIFdelbegin \DIFdel{Speed and strength of an epidemic intervention}\DIFdelend }%DIFAUXCMD
\author{\DIFdelbegin \DIFdel{Jonathan Dushoff, Sang Woo Park}\DIFdelend }%DIFAUXCMD
...
%DIFDELCMD < 	\Large
%DIFDELCMD < 	\textbf\newline{
%DIFDELCMD < 		Strength and speed of an epidemic intervention
%DIFDELCMD < 	}
%DIFDELCMD < }
%DIFDELCMD < %%%
...
The \DIFdelbeginFL \DIFdelFL{infection }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{post-intervention }\DIFaddendFL kernel after applying each intervention strategy \DIFdelbeginFL \DIFdelFL{$\hat K(\tau)$ }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$\Kpost(\tau)$ }\DIFaddendFL is shown in red.
