...
%DIF ADD speedstrength.tex                       Sat Feb  6 23:37:00 2021
...
For \DIFaddbegin \DIFadd{generalized }\DIFaddend interventions like lockdowns, which are generally assumed to affect everyone roughly equally, the strength-based perspective thus gives a clear (and somewhat surprising) answer: more early transmission means we will conclude that non-targeted interventions are \emph{more} effective \DIFaddbegin \DIFadd{because the effectiveness of intervention is not affected by the amount of early transmission (\figref{covid}B)}\DIFaddend .
